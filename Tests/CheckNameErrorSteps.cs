...
{
    [Binding]
    public class CheckNameErrorSteps
    {
        private readonly IWebDriver _driver;
        private string _loremText;
        public CheckNameErrorSteps()
        {
        ...
        public void WhenIFillTheFormAndLeaveNameFieldBlank()
        {
